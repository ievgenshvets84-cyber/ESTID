...
val SupportedLanguages = listOf(
    ...
    Language(
        ...
        nativeName = "中文",
        flag = "🇨🇳",
        ttsLocale = Locale.SIMPLIFIED_CHINESE,
    ...
    Language(
        ...
        initialTranslation = "Hallo! Schön, dich zu sehen. Worüber möchtest du heute sprechen?",
    ...
    Language(
        ...
        flag = "🇺🇦",
        ttsLocale = Locale.forLanguageTag("uk-UA"),
        initialGreeting = "Привіт! Як твої справи? Давай поспілкуємося!",
        initialTranslation = "Hallo! Wie geht es dir? Lass uns sprechen!",
        initialPronunciation = "Pryvit! Yak tvoi spravy? Davai pospilkuiemosia!"
    ),
    Language(
        code = "ru",
        name = "Russian",
        nativeName = "Русский",
        flag = "🇷🇺",
        ttsLocale = Locale.forLanguageTag("ru-RU"),
        initialGreeting = "Привет! Как твои дела сегодня? Давай попрактикуемся!",
        initialTranslation = "Hallo! Wie geht es dir heute? Lass uns üben!",
        initialPronunciation = "Privet! Kak tvoi dela segodnya? Davay popraktikuyemsya!"
    )
)
